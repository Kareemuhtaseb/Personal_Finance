...
<template>
  ...
  <div class="space-premium">
    ...
    <div class="glass-card-enhanced shadow-green-glow p-8">
      <div>
        ...
        <div class="space-y-6">
          ...
          <div class="flex justify-end">
            <button
              ...
              class="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
            >
