...
<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="text-center mb-8 animate-fade-in">
        <div class="w-16 h-16 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg mx-auto mb-4 relative overflow-hidden">
      ...
      <div class="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 relative overflow-hidden animate-fade-in-scale animate-delay-200">
        ...
        <div class="relative z-10">
          ...
          <div v-if="error" class="bg-red-500/20 border border-red-500/30 rounded-xl p-4 mb-6 relative overflow-hidden animate-bounce-in">
            <div class="absolute inset-0 bg-gradient-to-r from-red-500/10 to-red-600/10 rounded-xl"></div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <button
            type="submit"
            :disabled="isLoading"
            class="w-full px-6 py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 disabled:from-gray-500 disabled:via-gray-600 disabled:to-gray-700 text-white font-semibold rounded-2xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl disabled:cursor-not-allowed relative overflow-hidden group"
          >
